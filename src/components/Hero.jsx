          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="hidden sm:mb-8 sm:flex sm:justify-center">
              <div className="relative rounded-full py-1 px-3 text-sm leading-6 text-gray-300 ring-1 ring-gray-100/10 hover:ring-gray-900/20">
                ...
                <a href="https://youtu.be/qQAZNLGPdmI?list=PLaKLxbauAT7GElxFLUOw4EuZeBjnL4EFf" className="font-semibold text-youtube">
            ...
            <div className="text-center">
              ...
              <h2 className="mt-4 font-bold tracking-tight text-light sm:text-3xl">Toplanan Bağış: <span className="text-ahbap">$6.687.470.635,00</span></h2>
